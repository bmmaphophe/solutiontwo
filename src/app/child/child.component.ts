...
@Component({
  ...
  <div class="card-title"[hidden]="person.lastName === 'Moshe'"><span> LastName: {{person.lastName}}</span></div>
  <div class="card-title" *ngIf="person.age !==35"><span> Age: {{person.age}}</span></div>
